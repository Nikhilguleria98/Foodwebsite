...
const CartPage = () => {
  const { cartItems,setCartItems, removeFromCart, increaseQuantity } = useContext(StoreContext);
  ...
  <div className='flex flex-col-reverse md:flex-col '>
        ...
        <div className="mt-8 grid md:grid-cols-3 gap-6">
          ...
          <div className="col-span-2 bg-white border rounded-lg shadow-md p-6">
            ...
            <div className="flex justify-between items-center text-lg font-bold">
              <span>Total:</span>
              <span className="text-orange-500">₹{(calculateTotal() + 40).toFixed(2)}</span>
            </div>
          </div>
    ...
    {/* <div>
      <button onClick={handleclearAll} className='bg-red-500 text-white py-3 px-6 rounded-lg hover:bg-red-600 mt-4'>clear all</button>
    </div> */}
    </div>
  );
};
